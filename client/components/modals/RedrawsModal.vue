<template>
  <t-modal 
    v-model="show" 
    :header="total!==null ? `Redrawed ${total} times` : 'Loading...'" 
    width="400" 
    height="0" 
    @before-open="beforeOpen" 
    @closed="closed">
    <div 
      id="redraws-modal-content" 
        ...
        <div 
          ...
          <div class="flex-initial pr-2">
            <router-link :to="{ name: 'posts.show', params: { id: post.id } }">
              <img 
                :src="post.media[0].variations['100x100f'].url" 
          ...
          <div class="flex-grow">
            <div class="block">
              by <router-link 
                ...
                class="font-bold leading-none">{{ post.author.username }}</router-link>
            </div>
