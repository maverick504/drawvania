<template>
  <t-modal ref="modal" v-model="show" header="Create post" footerClass="bg-gray-100 p-4 text-right" width="540" @before-close="beforeClose">
    ...
    <form v-else class="-mt-4">
      ...
      <div v-if="parentPost" class="form-group mt-4">
        <div class="flex items-center text-sm">
          <div class="flex-initial pr-2">
            <img :src="parentPost.media[0].variations['50x50'].url" width="50" height="50" class="w-10 h-10 rounded">
          </div>
          <div class="flex-grow">
        ...
        <div class="bg-gray-900 text-center -mx-4">
          <div v-if="previewUrl" class="py-4">
            <div class="relative w-full h-auto mx-auto" style="max-width: 400px;">
              ...
              <button type="button" @click="clearFile()" class="absolute w-10 h-10 text-white text-center rounded-full" style="background-color: rgba(0, 0, 0, 0.25); top: 8px; right: 8px;">
